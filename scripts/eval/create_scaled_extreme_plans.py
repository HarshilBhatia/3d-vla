...
for src,setting in [('idlt_task_seen_group_v01.json','task_seen_group'),('idlt_task_heldout_group_v01.json','task_heldout_group')]:
 p=json.loads((ROOT/'instructions/eval_plans'/src).read_text());p['campaign_id']=f'idlt_scaled_extreme_{setting}_v01';p['calibration_registry']='instructions/eval_calibrations_idlt_scaled_extreme_v01.json';p['methods']=methods;p['calibrations']=['unknown-e30deg-t30cm','unknown-e40deg-t40cm'];p['task_calibrations']={}
 for t in p['tasks']:
  g=p['task_viewpoints'][t]['spawn_camera_group'].lower();p['task_calibrations'][t]=[f'seen-{g}-medium-unknown-e30deg-t30cm-v01',f'seen-{g}-medium-unknown-e40deg-t40cm-v01']
