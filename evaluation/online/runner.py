...
def build_environment_kwargs(args: Any) -> dict[str, Any]:
    ...
    if args.bimanual and "orbital" in dataset:
        ...
        return {
            ...
            "miscal_rot_level": None if materialized else getattr(args, "miscal_rot_level", None),
            "miscal_trans_level": None if materialized else getattr(args, "miscal_trans_level", None),
...
def run_online_evaluation(args: Any, *, model_loader: Callable[[Any], Any]) -> bool:
    ...
    success_rates = environment.evaluate_task_on_multiple_variations(
        ...
        proprio_num_history=getattr(args, "proprio_num_history", args.num_history),
