...
if __name__ == "__main__":
    ...
    # Preserve the historical relative-path contract while this file is
    # reachable from both the canonical and compatibility entry points.
    _script_dir = Path(__file__).resolve().parents[2] / "online_evaluation_rlbench"
    ...
    if args.bimanual:
        from evaluation.online.rlbench.backends.bimanual import RLBenchEnv
    elif "orbital" in args.dataset.lower():
        from evaluation.online.rlbench.backends.orbital import RLBenchEnv
    elif "peract" in args.dataset.lower():
        from evaluation.online.rlbench.backends.peract import RLBenchEnv
    else:
        from evaluation.online.rlbench.backends.hiveformer import RLBenchEnv
