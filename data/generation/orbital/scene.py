...
from data.generation.customized_rlbench import CustomizedScene, CustomizedEnvironment
...
class OrbitalEnvironment(CustomizedEnvironment):
    ...
    def launch(self):
        ...
        if self._randomize_every is None:
            ...
            class OrbitalDomainRandomizationScene(OrbitalScene, DomainRandomizationScene):
                pass
